...
public class ExceptionTranslator implements ProblemHandling/*, SecurityAdviceTrait*/ {
	...
	public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
		...
		if (problem instanceof DataIntegrityViolationException) {
			var test= ((DataIntegrityViolationException) problem).getRootCause();
			log.info("reat" +test);
			
		}
		if (problem instanceof PropertyValueException) {
			var test= ((DataIntegrityViolationException) problem).getRootCause();
			log.info("reat" +test);
